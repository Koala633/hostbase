...
window.set_title  "Hostbase 1.3 par Koala"
...
button1 = Gtk::Button.new("Attaquer 1 AP avec le WPA/2 et une page de phishing")
button2 = Gtk::Button.new("Hostapd avec le WPA/2 en 5GHz")

button.signal_connect("clicked")  {
dialog = Gtk::Dialog.new(
    "Carte wifi pour le scan",
    nil,
    Gtk::Dialog::MODAL,
...
dialog.default_response = Gtk::Dialog::RESPONSE_OK
label1 = Gtk::Label.new("Carte du fake AP")
label2 = Gtk::Label.new("SSID")
label3 = Gtk::Label.new("Canal du fake AP")
label4 = Gtk::Label.new("Page de phishing")
label5 = Gtk::Label.new("Bssid de l'ap ciblé")
label6 = Gtk::Label.new("Canal de l'ap ciblé")
label7 = Gtk::Label.new("Carte dos 5GHz")
label8 = Gtk::Label.new("Bssid 5GHz")
label9 = Gtk::Label.new("Canal 5GHz")
label10 = Gtk::Label.new("Carte dos 2.4GHz")
