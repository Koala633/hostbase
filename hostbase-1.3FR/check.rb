...
puts "Carte du fake AP sur wlan0, switch de wlan1 pour éviter les conflits avec le mode multi AP"
`ifconfig wlan1 down`
sleep 2
...
puts "switch de wlan0 pour éviter les conflits avec le mode multi AP"
`ifconfig wlan0 down`
