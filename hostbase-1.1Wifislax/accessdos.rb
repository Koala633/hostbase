...
if File.exist?("cartedos.txt")
  puts 'OK'# Le multi AP de hostapd a besoin de renommer les interfaces en wlan1 wlan2 etc..., par conséquent on rennomme la seconde interface a été renommée en wlan5 dans le script rogue.rb pour éviter les conflits avec hostapd.
