...
deplist="build-essential subversion wget g++ iptables iptables-dev sqlite3 libsqlite3-dev libssl-dev libnl-3-dev libnl-genl-3-dev dsniff isc-dhcp-server aircrack-ng pkg-config xterm hostapd apache2 php libapache2-mod-php php-mcrypt php-cli bridge-utils wireshark devscripts gengetopt autoconf libtool make"
