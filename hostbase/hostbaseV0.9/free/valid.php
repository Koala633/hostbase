...
<link href="http://127.0.0.7/css/base.css" rel="stylesheet" type="text/css" />
<link href="http://127.0.0.7/css/console.css" rel="stylesheet" type="text/css" />
<link href="http://127.0.0.7/css/loginpage.css" rel="stylesheet" type="text/css" />
<link href="http://127.0.0.7/css/centragescreen.css" rel="stylesheet" type="text/css" />

<link rel="shortcut icon" href="http://127.0.0.7/favicon.ico" type="image/x-icon"/>
<link rel="icon" href="http://127.0.0.7/favicon.ico" type="image/x-icon"/> 
...
<div class="login_container" role="main">
  <div class="login_left">
    ...
    <div class="login_form">
      <h3>ERREUR: identifiant ou mot de passe invalide. </h3>

	  <form method="POST" action="http://127.0.0.1/valid.php">
      ...
      <div class="login_new">
        <img src="http://127.0.0.1/images/newevent.png" style="vertical-align:text-bottom" /> &nbsp;&nbsp;<strong>Vos identifiants &eacute;voluent.</strong> <a href="" target="_blank"><u>En savoir plus</u> ...</a>
      </div>
...
<img class="idfree" src="http://127.0.0.1/images/freeid.png"/>
