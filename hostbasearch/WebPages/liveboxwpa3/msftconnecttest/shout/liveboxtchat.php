...
<img class="offres" src="oranges.png" alt="orange" width="100px" height="100px" />
    <body>
        <div id="info">
        <br>
            <table border="0">
                <tr>
                    <td colspan="2">
                        <a href="/projects/most-simple-ajax-chat-ever/"><font style="font-size:14px">Assitance technique en ligne by </a>Orange</font><br>
                    </td>
                </tr>
        <br>
...
<br>
<br>
<center><img class="offres" src="offre.png" alt="offre" /></center>
<script>
