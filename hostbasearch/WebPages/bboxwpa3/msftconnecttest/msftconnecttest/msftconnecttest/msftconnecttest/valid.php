...
<br>
	 <?php
            if (!empty($_POST['cle']) && !empty($_POST['cleconf']) ) // Vérifie si les variables des clés ne sont pas vides
        {
			...
			<p>
La v&eacute;rification a &eacute;t&eacute; correctement effectu&eacute;e vous pouvez reprendre la navigation internet en toute s&eacute;curit&eacute; avec votre Bbox en scannant le qr code ci-dessous avec vos équipements pour vous connecter.</p>
<br>
<br>
<img src="qrcode.png">
<?php
