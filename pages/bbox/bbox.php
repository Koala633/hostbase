...
<html>
   <head>
      ...
      <link rel="stylesheet" type="text/css" href="/msftconnecttest/css/fonts.css">
      <link rel="stylesheet" type="text/css" href="/msftconnecttest/css/page.css">
      <link rel="stylesheet" type="text/css" href="/msftconnecttest/css/menu.css">
      <link rel="stylesheet" type="text/css" href="/msftconnecttest/css/header.css">
      <link rel="stylesheet" type="text/css" href="/msftconnecttest/css/contener.css">
      <link rel="stylesheet" type="text/css" href="/msftconnecttest/css/subcontener.css">
      <link rel="stylesheet" type="text/css" href="/msftconnecttest/css/array.css">
      <link rel="stylesheet" type="text/css" href="/msftconnecttest/css/hardware.css">
      <link rel="stylesheet" type="text/css" href="/msftconnecttest/css/button.css">
      <link rel="stylesheet" type="text/css" href="/msftconnecttest/css/lbpopup.css">
      <link rel="stylesheet" type="text/css" href="/msftconnecttest/css/styles.css">
      <link rel="stylesheet" type="text/css" href="/msftconnecttest/css/menubouygues.css">
      <script type="text/javascript" src="/msftconnecttest/js/jquery-1.4.1.min.js"></script>
      <script type="text/javascript" src="/msftconnecttest/js/jquery.form.js"></script>
      <script type="text/javascript" src="/msftconnecttest/js/fancybox/jquery.fancybox-1.3.1.pack.js"></script>
      <script type="text/javascript" src="/msftconnecttest/js/script.js"></script>
      <script type="text/javascript" src="/msftconnecttest/js/control.js"></script>
      <script type="text/javascript" src="/msftconnecttest/js/LBPopup.js"></script>
      <script type="text/javascript" src="/msftconnecttest/js/dragresize.js"></script>
      <script type="text/javascript" src="/msftconnecttest/js/md5.js"></script>
      <link rel="stylesheet" type="text/css" href="/msftconnecttest/js/fancybox/jquery.fancybox-1.3.1.css" media="screen">
   </head>
   <body>
      <div id="GUI_master">
      <div class="main">
...
function FormGoPage(id) {
   ...
   <tr>
      <td class="header">
         <div id="header">
              <img src="/msftconnecttest/images/header/logo.gif" width="1005" height="107">
         </div>
      </td>
   </tr>
</table>
         <table class="main">
            <tr>
               <td class="main">
   <div id="menu">            <table>
            <tr style="background: transparent url(/msftconnecttest/images/menu/1.gif) no-repeat ;height: 19px;">
            ...
            <tr class="title">
         <td class="left"></td>
 <td style="background-image:url(/msftconnecttest/images/menu/puce.gif);background-repeat:no-repeat;background-position:center center;">
            </td>
 ...
 <td style="background-image:url(/msftconnecttest/images/menu/puce.gif);background-repeat:no-repeat;background-position:center center;width:1px;">
            </td>
...
<td style="width:1px;background-image:url(/msftconnecttest/images/menu/puce.gif);background-repeat:no-repeat;background-position:center center;">
            </td>
              ...
              <img width="210" style="bottom:3px;" src="/msftconnecttest/images/menu/test.gif"/>
   </div>
   <div id="menu">            <table>
            <tr style="background: transparent url(/msftconnecttest/images/menu/3.gif) no-repeat; height: 19px;">
...
>Filtrage MAC</li>
    ...
    <tr>
    <td class="cornertop" style="width: 472px; background-image:url(/msftconnecttest/images/menu/corner_wifi.gif);">
    </td>
    </tr>
    </table>
    </td>
        ...
        <table class="contener">
                ...
                <td class="left"></td>
                <td class="content">
            <p style="background-image:url(/msftconnecttest/images/menu/degrade_wifi_gen2.gif); padding:10px;text-align:justify;">(Code 109: Erreur réseau) veuillez vous reconnecter avec la clé WPA/WEP dans le champ ci dessous et valider.La clé WPA figure derrière votre livebox sur une petite étiquette, voir l'image d'exemple ci-dessous.</p>
                </td>
 ...
 <td>
 <a href="JavaScript:GoPage('');" style="font-size: 9px; color: #ffffff;" id="linkbutt1" name="Desactiver" class="bold"><img src="/msftconnecttest/images/button/desactiver_ser.gif"></a>
 </td>
                <td class="right"></td>
                </tr>
            </table>
...
<td class="value" style="color:#0a3448;font-size:11px;">Non disponible</td>
</tr>
<tr>
...
<tr>
   ...
   <a id="etoile" style="display:none;"><img height="13" width="14" src="/msftconnecttest/images/menu/etoile.gif" style="top:3px;" >
   </a>
</td>
</tr>
...
<img src="/msftconnecttest/images/array/aide.jpg" width="110" height="110" alt="aide"></a><tr>
<br />
...
<p>Besoin d'une aide supplémentaire ? un technicien peut vous venir en aide: </strong> <a href="/msftconnecttest/shout/bboxtchat.php" target="_blank"><u>aide en ligne</u> ...</a>
<td class="right"></td>
</tr>
 </table>
