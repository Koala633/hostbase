...
puts 'Choisissez une option en tapant le chiffre correspondant a ce que vous voulez faire (0,1,2,3 ou 4)'
...
puts "\e[1;32m[*] Choix 4: quitter le programme\e[0m"
...
when '4'
  ...
  puts "\e[1;31m[*] ERREUR: merci de sélectionner une option correcte (0,1,2,3 ou 4) !\e[0m"
end
