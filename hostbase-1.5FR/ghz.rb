...
sleep 1
`echo ghz > /tmp/hostbase-1.5FR/attack.txt`
...
EOF`
sleep 1   
        system "hostapd /tmp/hostapd.conf > /tmp/hostbase-1.5FR/hostapd.txt &> /dev/null &"
sleep 5
...
puts "\e[1;94m[*] Configuration du fake AP...\e[0m"
`ifconfig wlan0 up`
