...
puts "\e[1;32m[*] Choix 2: lancer le rogue AP et ensuite metaploit (configuration reverse shell par défaut)\e[0m"
puts "\e[1;32m[*] Choix 4: lancer le rogue AP et ensuite netcat IP: 175.0.0.1 et port d'écoute par défaut: 4444) \e[0m"
