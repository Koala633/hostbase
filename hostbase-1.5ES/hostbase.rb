...
window.set_title  "Hostbase 1.5 de Koala CodeName: Eucalyptus"
...
button1 = Gtk::Button.new("Iniciando un AP EN WPA/2 y DoS en 2.4GHz")
button2 = Gtk::Button.new("Iniciando un AP EN WPA/2 y DoS en 2.4GHz y 5GHz")
button3 = Gtk::Button.new("Iniciando un AP abierto y DoS en 2.4GHz")
button4 = Gtk::Button.new("Iniciando un AP abierto y DoS en 2.4GHz y 5GHz")
button5 = Gtk::Button.new("Iniciando el WPS PBC para intentar tener acceso a una red")
