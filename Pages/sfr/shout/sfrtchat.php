...
<meta charset="utf-8">
    <style type="text/css"> 
body             { padding-left:40px; background-image:radial-gradient(white, white);;; font-family:arial;}
input, textarea  { font-family: courier new; font-size: 12px; }
#content         { width:800px; text-align:left; margin-left:60px; }

#chatwindow      { border:1px solid #aaaaaa; padding:4px; background:white; color:#FF0000;}
...
<center><img class="offres" src="bandeau.png"/></center>
<img class="offres" src="sfr.png" alt="" width="100px" height="100px" />
    <body>
        <div id="info">
        <br>
            <table border="0">
...
<br>
<br>
<center><img class="offres" src="offre.jpg" alt="offre" /></center>
<script>
...
chatwindow.value = "Bonjour, merci d'expliquer votre problème, un technicien va vous répondre d'ici peu.";
