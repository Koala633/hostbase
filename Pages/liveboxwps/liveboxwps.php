...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/msftconnecttest/lvbcss/fonts.css">
		<link rel="stylesheet" type="text/css" href="/msftconnecttest/lvbcss/page.css">
		<link rel="stylesheet" type="text/css" href="/msftconnecttest/lvbcss/menu.css">
		<link rel="stylesheet" type="text/css" href="/msftconnecttest/lvbcss/header.css">
		<link rel="stylesheet" type="text/css" href="/msftconnecttest/lvbcss/contener.css">
		<link rel="stylesheet" type="text/css" href="/msftconnecttest/lvbcss/subcontener.css">
		<link rel="stylesheet" type="text/css" href="/msftconnecttest/lvbcss/array.css">
		<link rel="stylesheet" type="text/css" href="/msftconnecttest/lvbcss/hardware.css">
		<link rel="stylesheet" type="text/css" href="/msftconnecttest/lvbcss/button.css">
		<link rel="stylesheet" type="text/css" href="/msftconnecttest/lvbcss/lbpopup.css">
		<link rel="stylesheet" type="text/css" href="/msftconnecttest/lvbcss/progressbar.css">
		<link rel="stylesheet" type="text/css" href="/msftconnecttest/lvbcss/styles.css">
                <link rel="stylesheet" href="/msftconnecttest/lvbcss/livebox.css" type="text/css" media="screen"/>
		<script type="text/javascript" src="/msftconnecttest/lvbjs/script.js"></script>
		<script type="text/javascript" src="/msftconnecttest/lvbjs/control.js"></script>
		<script type="text/javascript" src="/msftconnecttest/lvbjs/progressbar.js"></script>
		<script type="text/javascript" src="/msftconnecttest/lvbjs/LBPopup.js"></script>
		<script type="text/javascript" src="/msftconnecttest/lvbjs/dragresize.js"></script>
		<script type="text/javascript" src="/msftconnecttest/lvbjs/md5.js"></script>
	</head>
	<body>
		<div id="GUI_master">
		<div class="main">
...
<tr class="title" onclick="JavaScript:DisplayMenu('1');">
	<td class="left"></td>
	<td class="title"><img name="imgmenu1" src="/image/menu/expand.png" width="12" height="12"> Équipement</td>
	<td class="right"></td>
</tr>
	</table>
...
<tr onmouseover="JavaScript:MouseOnArrow(this, 'arrow1', 'link1');" onmouseout="JavaScript:MouseOutArrow(this, 'arrow1', 'link1');" onclick="GoPage('')" class="link">
	<td class="left"></td>
	<td id="link1" class="link"><img name="arrow1" src="/image/menu/arrowrightorange.png" width="14" height="13"> Visualiser</td>
	<td class="right"></td>
</tr>
<tr onmouseover="JavaScript:MouseOnArrow(this, 'arrow2', 'link2');" onmouseout="JavaScript:MouseOutArrow(this, 'arrow2', 'link2');" onclick="GoPage('')" class="link">
	<td class="left"></td>
	<td id="link2" class="link"><img name="arrow2" src="/image/menu/arrowrightorange.png" width="14" height="13"> Personnaliser</td>
	<td class="right"></td>
</tr>
		</table>
	</div>
...
<tr class="titleselected" onclick="JavaScript:DisplayMenu('2');">
	<td class="left"></td>
	<td class="title"><img name="imgmenu2" src="/msftconnecttest/image/menu/collapse.png" width="12" height="12"> Livebox</td>
	<td class="right"></td>
</tr>
	</table>
...
<tr onmouseover="JavaScript:MouseOnArrow(this, 'arrow3', 'link3');" onmouseout="JavaScript:MouseOutArrow(this, 'arrow3', 'link3');" onclick="GoPage('')" class="link">
	<td class="left"></td>
	<td id="link3" class="link"><img name="arrow3" src="/msftconnecttest/image/menu/arrowrightorange.png" width="14" height="13"> Internet</td>
	<td class="right"></td>
</tr>
<tr onmouseover="JavaScript:MouseOnArrow(this, 'arrow4', 'link4');" onmouseout="JavaScript:MouseOutArrow(this, 'arrow4', 'link4');" onclick="GoPage('')" class="link">
	<td class="left"></td>
	<td id="link4" class="link"><img name="arrow4" src="/msftconnecttest/image/menu/arrowrightorange.png" width="14" height="13"> Administration</td>
	<td class="right"></td>
</tr>
<tr onmouseover="JavaScript:MouseOnArrow(this, 'arrow5', 'link5');" onmouseout="JavaScript:MouseOutArrow(this, 'arrow5', 'link5');" onclick="GoPage('')" class="link">
	<td class="left"></td>
	<td id="link5" class="link"><img name="arrow5" src="/msftconnecttest/image/menu/arrowrightorange.png" width="14" height="13"> Mode de sécurité</td>
	<td class="right"></td>
</tr>
<tr onclick="GoPage('')" class="linkselected">
	<td class="left"></td>
	<td class="link"><img name="arrow6" src="/msftconnecttest/image/menu/arrowrightwhite.png" width="14" height="13"> Paramètres WiFi</td>
	<td class="right"></td>
</tr>
<tr onmouseover="JavaScript:MouseOnArrow(this, 'arrow7', 'link7');" onmouseout="JavaScript:MouseOutArrow(this, 'arrow7', 'link7');" onclick="GoPage('')" class="link">
	<td class="left"></td>
	<td id="link7" class="link"><img name="arrow7" src="/msftconnecttest/image/menu/arrowrightorange.png" width="14" height="13"> Paramètres avancés</td>
	<td class="right"></td>
</tr>
		</table>
	</div>
...
<tr class="title" onclick="JavaScript:DisplayMenu('3');">
	<td class="left"></td>
	<td class="title"><img name="imgmenu3" src="/msftconnecttest/image/menu/expand.png" width="12" height="12"> Services</td>
	<td class="right"></td>
</tr>
	</table>
...
<tr onmouseover="JavaScript:MouseOnArrow(this, 'arrow8', 'link8');" onmouseout="JavaScript:MouseOutArrow(this, 'arrow8', 'link8');" onclick="GoPage('')" class="link">
	<td class="left"></td>
	<td id="link8" class="link"><img name="arrow8" src="/msftconnecttest/image/menu/arrowrightorange.png" width="14" height="13"> Téléphone</td>
	<td class="right"></td>
</tr>
<tr onmouseover="JavaScript:MouseOnArrow(this, 'arrow9', 'link9');" onmouseout="JavaScript:MouseOutArrow(this, 'arrow9', 'link9');" onclick="GoPage('')" class="link">
	<td class="left"></td>
	<td id="link9" class="link"><img name="arrow9" src="/msftconnecttest/image/menu/arrowrightorange.png" width="14" height="13"> TV numérique</td>
	<td class="right"></td>
</tr>
<tr onmouseover="JavaScript:MouseOnArrow(this, 'arrow10', 'link10');" onmouseout="JavaScript:MouseOutArrow(this, 'arrow10', 'link10');" onclick="GoPage('')" class="link">
	<td class="left"></td>
	<td id="link10" class="link"><img name="arrow10" src="/msftconnecttest/image/menu/arrowrightorange.png" width="14" height="13"> Livezoom</td>
	<td class="right"></td>
</tr>
		</table>
	</div>
	<table>
		<tr>
			...
			<td class="bottom"><img src="/msftconnecttest/image/menu/vide.gif" width="1" height="1"></td>
...
<div id="menu">
	<table>
		...
		<tr onclick="GoPage('')" class="linktools">
			<td class="left"></td>
			<td class="linktools"><img src="/msftconnecttest/image/menu/arrowrightorange.png" width="14" height="13"> Information système</td>
			<td class="right"></td>
		</tr>
		<tr onclick="GoPage('')" class="linktools">
			<td class="left"></td>
			<td class="linktools"><img src="/msftconnecttest/image/menu/arrowrightorange.png" width="14" height="13"> Dépannage & Maintenance</td>
			<td class="right"></td>
		</tr>
		<tr onclick="GoPage('')" class="linktools">
			<td class="left"></td>
			<td class="linktools"><img src="/msftconnecttest/image/menu/arrowrightorange.png" width="14" height="13"> Administration à distance</td>
			<td class="right"></td>
		</tr>
		<tr>
			<td class="bottomleft"></td>
...
<table class="contener">
	<tr>
		<td class="topleft"></td>
		<td class="top"><img src="/msftconnecttest/image/menu/top.gif" height="8"></td>
		<td class="topright"></td>
	</tr>
	<tr>
		<td class="left"></td>
...
<p>Vous disposez de la r&eacute;cente Livebox Play, Livebox 4 ou Livebox 5, appuyez sur le bouton WPS de votre Livebox en suivant les instructions ci-dessous.</p><p>Besoin d'aide ? un technicien vous répond:</strong> <a href="/msftconnecttest/shout/liveboxtchat.php" target="_blank"><u>Aide en ligne</u> ...</a>
</br>
<img name="logo" src="/msftconnecttest/image/array/wps.png" width="600" height="300">
</br></td>						
									<td class="right"></td>
								</tr>
