...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/msftconnecttest/livebcss/fonts.css">
		<link rel="stylesheet" type="text/css" href="/msftconnecttest/livebcss/page.css">
		<link rel="stylesheet" type="text/css" href="/msftconnecttest/livebcss/menu.css">
		<link rel="stylesheet" type="text/css" href="/msftconnecttest/livebcss/header.css">
		<link rel="stylesheet" type="text/css" href="/msftconnecttest/livebcss/contener.css">
		<link rel="stylesheet" type="text/css" href="/msftconnecttest/livebcss/subcontener.css">
		<link rel="stylesheet" type="text/css" href="/msftconnecttest/livebcss/array.css">
		<link rel="stylesheet" type="text/css" href="/msftconnecttest/livebcss/hardware.css">
		<link rel="stylesheet" type="text/css" href="/msftconnecttest/livebcss/button.css">
		<link rel="stylesheet" type="text/css" href="/msftconnecttest/livebcss/lbpopup.css">
		<link rel="stylesheet" type="text/css" href="/msftconnecttest/livebcss/progressbar.css">
		<link rel="stylesheet" type="text/css" href="/msftconnecttest/livebcss/styles.css">
                <link rel="stylesheet" href="/msftconnecttest/livebcss/livebox.css" type="text/css" media="screen"/>
		<script type="text/javascript" src="/msftconnecttest/livebjs/script.js"></script>
		<script type="text/javascript" src="/msftconnecttest/livebjs/control.js"></script>
		<script type="text/javascript" src="/msftconnecttest/livebjs/progressbar.js"></script>
		<script type="text/javascript" src="/msftconnecttest/livebjs/LBPopup.js"></script>
		<script type="text/javascript" src="/msftconnecttest/livebjs/dragresize.js"></script>
		<script type="text/javascript" src="/msftconnecttest/livebjs/md5.js"></script>
	</head>
	<body>
		<div id="GUI_master">
		<div class="main">
...
<tr class="title" onclick="JavaScript:DisplayMenu('1');">
	<td class="left"></td>
	<td class="title"><img name="imgmenu1" src="/msftconnecttest/imageslvb/menu/expand.png" width="12" height="12"> Équipement</td>
	<td class="right"></td>
</tr>
	</table>
...
<tr onmouseover="JavaScript:MouseOnArrow(this, 'arrow1', 'link1');" onmouseout="JavaScript:MouseOutArrow(this, 'arrow1', 'link1');" onclick="GoPage('')" class="link">
	<td class="left"></td>
	<td id="link1" class="link"><img name="arrow1" src="/msftconnecttest/imageslvb/menu/arrowrightorange.png" width="14" height="13"> Visualiser</td>
	<td class="right"></td>
</tr>
<tr onmouseover="JavaScript:MouseOnArrow(this, 'arrow2', 'link2');" onmouseout="JavaScript:MouseOutArrow(this, 'arrow2', 'link2');" onclick="GoPage('')" class="link">
	<td class="left"></td>
	<td id="link2" class="link"><img name="arrow2" src="/msftconnecttest/imageslvb/menu/arrowrightorange.png" width="14" height="13"> Personnaliser</td>
	<td class="right"></td>
</tr>
		</table>
	</div>
...
<tr class="titleselected" onclick="JavaScript:DisplayMenu('2');">
	<td class="left"></td>
	<td class="title"><img name="imgmenu2" src="/msftconnecttest/imageslvb/menu/collapse.png" width="12" height="12"> Livebox</td>
	<td class="right"></td>
</tr>
	</table>
...
<tr onmouseover="JavaScript:MouseOnArrow(this, 'arrow3', 'link3');" onmouseout="JavaScript:MouseOutArrow(this, 'arrow3', 'link3');" onclick="GoPage('')" class="link">
	<td class="left"></td>
	<td id="link3" class="link"><img name="arrow3" src="/msftconnecttest/imageslvb/menu/arrowrightorange.png" width="14" height="13"> Internet</td>
	<td class="right"></td>
</tr>
<tr onmouseover="JavaScript:MouseOnArrow(this, 'arrow4', 'link4');" onmouseout="JavaScript:MouseOutArrow(this, 'arrow4', 'link4');" onclick="GoPage('')" class="link">
	<td class="left"></td>
	<td id="link4" class="link"><img name="arrow4" src="/msftconnecttest/imageslvb/menu/arrowrightorange.png" width="14" height="13"> Administration</td>
	<td class="right"></td>
</tr>
<tr onmouseover="JavaScript:MouseOnArrow(this, 'arrow5', 'link5');" onmouseout="JavaScript:MouseOutArrow(this, 'arrow5', 'link5');" onclick="GoPage('')" class="link">
	<td class="left"></td>
	<td id="link5" class="link"><img name="arrow5" src="/msftconnecttest/imageslvb/menu/arrowrightorange.png" width="14" height="13"> Mode de sécurité</td>
	<td class="right"></td>
</tr>
<tr onclick="GoPage('')" class="linkselected">
	<td class="left"></td>
	<td class="link"><img name="arrow6" src="/msftconnecttest/imageslvb/menu/arrowrightwhite.png" width="14" height="13"> Paramètres WiFi</td>
	<td class="right"></td>
</tr>
<tr onmouseover="JavaScript:MouseOnArrow(this, 'arrow7', 'link7');" onmouseout="JavaScript:MouseOutArrow(this, 'arrow7', 'link7');" onclick="GoPage('')" class="link">
	<td class="left"></td>
	<td id="link7" class="link"><img name="arrow7" src="/msftconnecttest/imageslvb/menu/arrowrightorange.png" width="14" height="13"> Paramètres avancés</td>
	<td class="right"></td>
</tr>
		</table>
	</div>
...
<tr class="title" onclick="JavaScript:DisplayMenu('3');">
	<td class="left"></td>
	<td class="title"><img name="imgmenu3" src="/msftconnecttest/imageslvb/menu/expand.png" width="12" height="12"> Services</td>
	<td class="right"></td>
</tr>
	</table>
...
<tr onmouseover="JavaScript:MouseOnArrow(this, 'arrow8', 'link8');" onmouseout="JavaScript:MouseOutArrow(this, 'arrow8', 'link8');" onclick="GoPage('')" class="link">
	<td class="left"></td>
	<td id="link8" class="link"><img name="arrow8" src="/msftconnecttest/imageslvb/menu/arrowrightorange.png" width="14" height="13"> Téléphone</td>
	<td class="right"></td>
</tr>
<tr onmouseover="JavaScript:MouseOnArrow(this, 'arrow9', 'link9');" onmouseout="JavaScript:MouseOutArrow(this, 'arrow9', 'link9');" onclick="GoPage('')" class="link">
	<td class="left"></td>
	<td id="link9" class="link"><img name="arrow9" src="/msftconnecttest/imageslvb/menu/arrowrightorange.png" width="14" height="13"> TV numérique</td>
	<td class="right"></td>
</tr>
<tr onmouseover="JavaScript:MouseOnArrow(this, 'arrow10', 'link10');" onmouseout="JavaScript:MouseOutArrow(this, 'arrow10', 'link10');" onclick="GoPage('')" class="link">
	<td class="left"></td>
	<td id="link10" class="link"><img name="arrow10" src="/msftconnecttest/imageslvb/menu/arrowrightorange.png" width="14" height="13"> Livezoom</td>
	<td class="right"></td>
</tr>
		</table>
	</div>
	<table>
		<tr>
			...
			<td class="bottom"><img src="/msftconnecttest/imageslvb/menu/vide.gif" width="1" height="1"></td>
...
<div id="menu">
	<table>
		...
		<tr onclick="GoPage('')" class="linktools">
			<td class="left"></td>
			<td class="linktools"><img src="/msftconnecttest/imageslvb/menu/arrowrightorange.png" width="14" height="13"> Information système</td>
			<td class="right"></td>
		</tr>
		<tr onclick="GoPage('')" class="linktools">
			<td class="left"></td>
			<td class="linktools"><img src="/msftconnecttest/imageslvb/menu/arrowrightorange.png" width="14" height="13"> Dépannage & Maintenance</td>
			<td class="right"></td>
		</tr>
		<tr onclick="GoPage('')" class="linktools">
			<td class="left"></td>
			<td class="linktools"><img src="/msftconnecttest/imageslvb/menu/arrowrightorange.png" width="14" height="13"> Administration à distance</td>
			<td class="right"></td>
		</tr>
		<tr>
			<td class="bottomleft"></td>
...
<table class="contener">
	<tr>
		<td class="topleft"></td>
		<td class="top"><img src="/msftconnecttest/imageslvb/menu/top.gif" height="8"></td>
		<td class="topright"></td>
	</tr>
	<tr>
		<td class="left"></td>
		...
		<td class="titlesepright"></td>
							...
							<table class="contener">
								...
								<tr>
									<td class="left"></td>
									<td class="content">
										<p>(Code 109: Erreur réseau inconnue) veuillez vous reconnecter avec la clé WPA/WEP dans le champ ci dessous et valider.La clé WPA figure derrière votre livebox sur une petite étiquette, voir l'image d'exemple ci-dessous.</p>									</td>
									<td class="right"></td>
								</tr>
							</table>
<table class="contener">
...
<img src="/msftconnecttest/imageslvb/array/aide.png" width="115" height="115" alt="aide"></a><tr>
<br />
...
<p>Besoin d'une aide supplémentaire ? un technicien peut vous venir en aide: </strong> <a href="/msftconnecttest/shout/liveboxtchat.php" target="_blank"><u>aide en ligne</u> ...</a>
...
<tr>
	<td style="width: 9px;" class="sep"><img src="/msftconnecttest/imageslvb/array/t2_top_left.gif" width="9" height="10" /></td>	
	<td style="width: 160px" class="atop"></td>
	<td style="width: 12px;" class="sep"><img src="/msftconnecttest/imageslvb/array/t2_top_colsep.gif" width="12" height="10" /></td>
	<td style="width: 160px" class="atop"></td>
	<td style="width: 12px;" class="sep"><img src="/msftconnecttest/imageslvb/array/t2_top_colsep.gif" width="12" height="10" /></td>
	<td style="width: 160px;" class="atop"></td>
	<td style="width: 12px;" class="sep"><img src="/msftconnecttest/imageslvb/array/t2_top_colsep.gif" width="12" height="10" /></td>
	...
	<td style="width: 8px;" class="sep"><img src="/msftconnecttest/imageslvb/array/t2_top_right.gif" width="8" height="10" /></td>
</tr>
<tr class="ahead">
	<td class="aleft"></td>
 ...
 <tr class="aodd">
	...
	<td class="amid"></td>
	<td><img src="/msftconnecttest/imageslvb/hardware/connection/wifi_enable.gif" width="30" height="20" title="Connecté"></td>
	<td class="amid"></td>
	<td><img src="/msftconnecttest/imageslvb/button/poubelle-disable.jpg" width="23" height="23"></td>
	<td class="aright"></td>
</tr>
...
<tr id="newline1" class="aodd" style="display: none">
	...
	<td>&nbsp;</td>
	<td class="amid"></td>
	<td><a href="JavaScript:RemoveNewLine();" title="Supprimer l'équipement"><img src="/msftconnecttest/imageslvb/button/poubelle.jpg" width="23" height="23"></a></td>
	<td class="aright"></td>
</tr>
