...
#chatwindow      { border:1px solid #aaaaaa; padding:4px; background:white; color:#04B4AE;}
...
<img class="offres" src="logobbox.jpg" alt="" width="300px" height="200px" />
    <body>
        <div id="info">
        <br>
            <table border="0">
...
<br>
<br>
<center><img class="offres" src="pub.jpeg" alt="offre" /></center>
<script>
